...
Public Class frmSupplier
    Sub kondisiAwal()
        ...
        btnTutup.Text = "Tutup"
        Call KONEKSI()
        DA = New OdbcDataAdapter("select id, nama, alamat, telepon from supplier", CONN)
        DS = New DataSet
        DA.Fill(DS, "supplier")
    ...
    Private Sub btnInput_Click(sender As Object, e As EventArgs) Handles btnInput.Click
        ...
        Else
            ...
            Else
                Call KONEKSI()
                Dim InputData As String = "INSERT INTO supplier (id, nama, alamat, telepon) VALUES ('" & txtId.Text & "', '" & txtNama.Text & "', '" & txtAlamat.Text & "', '" & txtTelp.Text & "')"
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        Else
            ...
            Else
                Call KONEKSI()
                Dim UpdateData As String = "UPDATE supplier SET id='" & txtId.Text & "', nama= '" & txtNama.Text & "', alamat= '" & txtAlamat.Text & "', telepon= '" & txtTelp.Text & "' WHERE id= '" & txtId.Text & "'   "
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        Else
            ...
            Else
                Call KONEKSI()
                Dim HapusData As String = "DELETE FROM supplier WHERE id= '" & txtId.Text & "' "
    ...
    Private Sub txtId_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtId.KeyPress
        If e.KeyChar = Chr(13) Then
            Call KONEKSI()
            CMD = New OdbcCommand("select * from supplier where id='" & txtId.Text & "'", CONN)
    ...
    Sub NomorOtomatis()
        Call KONEKSI()
        CMD = New OdbcCommand("select * from supplier where id in (select max(id) from supplier)", CONN)
        ...
        Else
            ...
            UrutanKode = "SP" + Microsoft.VisualBasic.Right("0000" & Hitung, 4)
        End If
