Public Class frmLapBeli
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        cetak.Show()
        cetak.CRV.SelectionFormula = "totext({pembelian.tglBeli})='" & DateTimePicker1.Value & "'"
        cetak.CRV.ReportSource = "lapBelHar.rpt"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        cetak.Show()
        cetak.CRV.SelectionFormula = "{pembelian.tglBeli} in date (" & Label6.Text & ") to date (" & Label7.Text & ")"
        cetak.CRV.ReportSource = "lapBelMing.rpt"
        cetak.CRV.RefreshReport()
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Else
            cetak.Show()
            cetak.CRV.SelectionFormula = "Month({pembelian.tglBeli})=" & Val(ComboBox1.Text) & " and year ({pembelian.tglBeli})=" & Val(ComboBox2.Text)
            cetak.CRV.ReportSource = "lapBelBul.rpt"
            cetak.CRV.RefreshReport()
        End If
    End Sub
